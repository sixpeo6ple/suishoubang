<template>
	<view>
		<view class="comb">
			<text class="title" v-if="type == '快递'">取件码</text>
			<text class="title" v-if="type == '外卖'">取货地点</text>
			<text class="value">{{ info }}</text>
			
			<text class="title" v-if="type == '快递'">收件人</text>
			<text class="title" v-if="type == '外卖'">请求者</text>
			<text class="value">{{ payername }}</text>
			
			<text class="title" v-if="type == '快递'">收件地址</text>
			<text class="title" v-if="type == '外卖'">收货地址</text>
			<text class="value">{{ payerplace }}</text>
			
			<text class="title" v-if="type == '快递'">收件方式</text>
			<text class="title" v-if="type == '外卖'">收货方式</text>
